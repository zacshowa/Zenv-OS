...
-- Menu mods with Rofi, including drun, window, and regular run.
-- These have to have modifiers with more than 1 key first to resolve correctly. Otherwise, the single key will execute despite other keys being pressed beforehand.
-- e.g. if mainMod + R is used, typing mainMod + D + R seems to execute mainMod + R anyways. This might be a bit of lua weirdness?
