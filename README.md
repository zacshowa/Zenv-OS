# Zenv-OS
This repo contains the NixOS configuration that I use to run my dev environment, as well as a submodule for my dotfiles that are managed in part by home-manager.
